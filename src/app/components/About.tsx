        ...
        <div className="flex flex-col-reverse gap-4 sm:grid sm:grid-cols-2 mt-10">
          <div className="flex flex-col gap-4">
            <p className="text-justify">
              I&apos;m not just someone who writes code—I&apos;m a problem
              solver, a creative thinker, and a tech enthusiast. I love diving
              into complex challenges and architecting solutions that deliver
            ...
            <p className="text-justify">
              {" "}
              In essence, I&apos;m not just passionate about software
              development—I&apos;m passionate about the people, the projects,
              and the possibilities that come with it. And I&apos;m excited to
              embark on this journey of continuous learning, growth, and
              innovation with like-minded individuals who share my vision for
